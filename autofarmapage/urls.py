...
urlpatterns = [
    ...
    path('deshabilitarpage/<slug:rut>',
         views.deshabilitarUsuario,  name='deshabilitarpage'),
    path('exito-crear-usuario', views.guardadoUsuarioExito,
         name='exito-crear-usuario'),
    path('exito-guardar-tutor', views.guardadoTutorExito,
         name='exito-guardar-tutor'),
    path('exito-modificar-usuario', views.modificarUsuarioExito,
         name='exito-modificar-usuario'),
    path('logout', views.logout),

    # urls farmacia
    path('inicio-farmacia', views.inicioFarmacia, name='inicio-farmacia'),
    path('homefarma', views.homeFarmacia, name='homefarma'),
    path('agregar-medicamento', views.agregarMedicamento,
    ...
    path('exito-crear-medicamento', views.guardadoMedicamentoExito,
         name='exito-crear-medicamento'),
    path('inicio-entregas', views.inicioEntregas, name='inicio-entregas'),
    path('entregas-pendientes', views.entregasPendientes,
         name='entregas-pendientes'),
    path('entrega-medicamento/<int:id_receta>',
         views.entregaMedicamento, name='entrega-medicamento'),
    path('resultado-entrega/<int:id_receta>/<int:codigo_med>/<int:cantidad>/<int:numMensaje>',
         views.entregaResultado, name='resultado-entrega'),

    # urls médico
    path('home_medico', views.home_medico, name='home_medico'),
    path('crear-receta', views.crearreceta, name="crear-receta"),
    path('crear-receta2/<int:id_receta>',
         views.crearreceta2, name="crear-receta2"),
